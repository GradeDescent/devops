{
  ...
  api = { name, nodes, pkgs, modulesPath, lib, ... }:
  let
  ...
  in
  {
    ...
    security.acme.certs."api.gradedescent.com".email = "fowler@rossprogram.org";
    ...
    systemd.services.prisma-migrate = {
      ...
      serviceConfig = {
        ...
        # Extra safety (in case init was fast but DB not yet ready)
